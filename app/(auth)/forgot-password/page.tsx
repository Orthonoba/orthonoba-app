...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!emailOk) {
      setStatus({ type: "error", message: "Por favor introduce un email válido." });
      return;
    }
    ...
    try {
      ...
      setStatus({
        type: "success",
        message: "Revisa tu correo (incluye spam). Si existe, recibirás instrucciones en 5 minutos.",
      });
      setEmail("");
    } catch (err) {
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">Recuperar acceso</h1>
            <p className="text-slate-300 text-sm">Te ayudamos a volver a tu cuenta</p>
          </div>
