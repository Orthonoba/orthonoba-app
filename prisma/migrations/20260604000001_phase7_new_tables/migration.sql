...
-- AlterTable
ALTER TABLE "Archivo" ADD COLUMN     "nombre" TEXT,
ADD COLUMN     "sizeBytes" INTEGER;

-- AlterTable
ALTER TABLE "Caso" ADD COLUMN     "estado" "CasoEstado" NOT NULL DEFAULT 'RECIBIDO',
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;

-- AlterTable
ALTER TABLE "Paciente" ADD COLUMN     "organizationId" TEXT;

-- DropTable
DROP TABLE "solicitar_demo";
